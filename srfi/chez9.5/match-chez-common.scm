...
(test-equal "list __1" '(a b c)
	    (match '(a b c) ((x __1) x)))

(test-equal "list __1 failed" #f
	    (match '()
		   ((x __1) x)
		   (else #f)))

(test-equal "list __1 with predicate" '(a b c)
	    (match '(a b c)
		   (((and x (? symbol?)) __1) x)))

(test-equal "list __1 with failed predicate" #f
	    (match '(a b 3)
		   (((and x (? symbol?)) __1) x)
		   (else #f)))

(test-equal "list __= too few" #f
	    (match (list 1 2) ((a b __= 2) b) (else #f)))
(test-equal "list __=" '(2 3)
	    (match (list 1 2 3) ((a b __= 2) b) (else #f)))
(test-equal "list __= too many" #f
	    (match (list 1 2 3 4) ((a b __= 2) b) (else #f)))
(test-equal "list __= tail" 4
	    (match (list 1 2 3 4) ((a b __= 2 c) c) (else #f)))
(test-equal "list __= tail fail" #f
	    (match (list 1 2 3 4 5 6) ((a b __= 2 c) c) (else #f)))

(test-equal "list __* too few" #f
	    (match (list 1 2) ((a b __* 2 4) b) (else #f)))
(test-equal "list __* lo" '(2 3)
	    (match (list 1 2 3) ((a b __* 2 4) b) (else #f)))
(test-equal "list __* hi" '(2 3 4 5)
	    (match (list 1 2 3 4 5) ((a b __* 2 4) b) (else #f)))
(test-equal "list __* too many" #f
	    (match (list 1 2 3 4 5 6) ((a b __* 2 4) b) (else #f)))
(test-equal "list __* tail" 4
	    (match (list 1 2 3 4) ((a b __* 2 4 c) c) (else #f)))
(test-equal "list __* tail 2" 5
	    (match (list 1 2 3 4 5) ((a b __* 2 4 c d) d) (else #f)))
(test-equal "list __* tail" 6
	    (match (list 1 2 3 4 5 6) ((a b __* 2 4 c) c) (else #f)))
(test-equal "list __* tail fail" #f
	    (match (list 1 2 3 4 5 6 7) ((a b __* 2 4 c) c) (else #f)))
