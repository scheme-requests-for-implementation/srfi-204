(library (match)
	 (export match match-lambda match-lambda* match-let match-letrec match-let*
		 ___ :_ __1 __= __* *** ? $ struct _@ object get!)
	 (import (scheme))
	 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	 ;;;; auxiliary syntax for exports
	 ;;;; without this 28 tests fail
	 (define-syntax :_
	   (syntax-rules ()
	     ((_ expr ...)
	      (syntax-error ":_ outside of pattern"))))
	 (define-syntax ___
	   (syntax-rules ()
	     ((_ expr ...)
	 ...
	 (define-syntax __1
	   (syntax-rules ()
	     ((_ expr ...)
	      (syntax-error "__1 outside of pattern"))))
	 (define-syntax __=
	   (syntax-rules ()
	     ((_ expr ...)
	      (syntax-error "__= outside of pattern"))))
	 (define-syntax __*
	   (syntax-rules ()
	     ((_ expr ...)
	      (syntax-error "__* outside of pattern"))))
